...
import { BASE_URL } from "../utils/env"; // Import the base URL from utils

const SuperAdminForgotPass = () => {
  ...
  const handleSendOtp = async () => {
    try {
      await axios.post(`${BASE_URL}/superAdminAuth/send-otp`, {
        emailOrMobile,
      });
      setOtpSent(true);
      setError("");
  ...
  const handleVerifyOtp = async () => {
    try {
      const response = await axios.post(
        `${BASE_URL}/superAdminAuth/verify-otp`,
        { emailOrMobile, otp },
        {
...
export default SuperAdminForgotPass;
